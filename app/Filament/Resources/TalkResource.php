    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filtersTriggerAction(function ($action) {
                return $action->button()->label('Filers');
            })
            ->columns([
                Tables\Columns\TextColumn::make('title')
                    ...
                    ->description(function (Talk $talk) {
                        return Str::limit($talk->abstract, 40);
                    }),
                ...
                Tables\Actions\BulkActionGroup::make([
                    Tables\Actions\BulkAction::make('approve selected')
                        ...
                        ->action(function (Collection $talks) {
                            ...
                            Notification::make()
                                ->success()
                                ->title('Talks where approved')
                                ->duration(3000)
                                ->body('The talks has been approved and the speakers has been notified')
                                ->send();
                        }),
